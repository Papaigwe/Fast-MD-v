...
zokou({ nomCom: "dev", categorie: "Général", reaction: "💞" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      ...
      { nom: "techigwe᚜", numero: "24160338758" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "👋 Bienvenue chez FAST ! Voici les développeurs :\n\n";
...
zokou({ nomCom: "support", categorie: "Général" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `ecrit moi je te met 24160338758`},{quoted :ms})
